...
import org.kobehjk.net.utils.UiHelper;
import org.kobehjk.net.support.okhttp.OkHttpClientManager;
import org.kobehjk.net.utils.NetWorkUtils;
import org.kobehjk.net.utils.SystemBarTintManager;
import org.kobehjk.net.widget.SolidToast;
...
public class BaseCompatActivity extends AppCompatActivity {
    ...
    private void showOpenWifiDialog() {
        final Dialog dialog = new Dialog(this, "提醒", "检测到当前网络没有连接是否开启网络？");
    ...
    private void showExitDialog(String msg) {
        final Dialog dialog = new Dialog(this, "提醒", msg);
        dialog.setOnAcceptButtonClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.dismiss();
